...
@section('content')
    <div class="container-fluid px-4">
        ...
        @endif
        <div class="row">
            {{-- start not published posts --}}
            <div class="card shadow col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-3 ">
                <h4 >Not publishd</h4>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="post-publish" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Sno.</th>
                                        <th>Name</th>
                ...
                <div class="card shadow col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-3">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="post-published" class="table table-bordered table-striped" slot="">
                                <thead>
                                    <tr>
                                        <th>Sno.</th>
                                        <th>Name</th>
